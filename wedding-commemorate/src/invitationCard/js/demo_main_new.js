function boot() {
  ...
  this.API = {
    sdkData: function () {
      return /(m|www|admin).hunliji.com/i.test(window.location.hostname)
        ? '//logs.hunliji.com/v1/api/app/tracker/batch.json' : '//log7.hunliji.com/v1/api/app/tracker/batch.json'
    }(),
...
boot.prototype = function () {
  ...
  guestAction = function () {
    ...
    var _code = '<div id="gusetCode" style="padding:0 ' + _p30 + 'px 0 ' + _p30 + 'px; ">\
                                <div class="guest-reply"><i style="font-weight:700">您的姓名</i><input id="gusetName" class="guset_name" style="width:70%;margin-left:' + _p30 + 'px;padding:' + _p30 + 'px 0 ' + _p30 + 'px 0;" type="text" placeholder="请输入您的姓名..."/></div>\
